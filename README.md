...
## Training
We prepared demo scripts for the blender(`run_blender.py`), nerf360(`run_360.py`), and DTU(`run_DTUeval.py`) dataset. Remember to set smaller ksort buffer size (e.g. 16) for large scenes in nerf360 and re-install the rasterizer before training.
